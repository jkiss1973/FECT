...
namespace FECT.Tokenizer.Detectors
{
	...
	public class SingleChar_Detector : BaseDetector
		{
		public string MoreChars {get; set;}

		public SingleChar_Detector()
		{
			MoreChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
		}
